...
enum opt_code
{
  ...
  OPT_list = 1889,                           /* -list */
  OPT_mabi_ = 1890,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1891,             /* -mabort-on-noreturn */
  OPT_mandroid = 1892,                       /* -mandroid */
  ...
  OPT_mbranch_cost_ = 1904,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 1905,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 1906,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1907,     /* -mcaller-super-interworking */
  OPT_mcmse = 1908,                          /* -mcmse */
  OPT_mcpu_ = 1909,                          /* -mcpu= */
  OPT_mfdpic = 1910,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1911,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1912,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1913, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1914,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1915,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1916,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1917,                  /* -mfp16-format= */
  OPT_mfpu_ = 1918,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1919,             /* -mgeneral-regs-only */
  OPT_mglibc = 1920,                         /* -mglibc */
  /* OPT_mhard_float = 1921, */              /* -mhard-float */
  OPT_mlibarch_ = 1922,                      /* -mlibarch= */
  OPT_mlittle_endian = 1923,                 /* -mlittle-endian */
  OPT_mlong_calls = 1924,                    /* -mlong-calls */
  OPT_mmusl = 1925,                          /* -mmusl */
  OPT_mneon_for_64bits = 1926,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1927,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1928,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1929,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1930,               /* -mprint-tune-info */
  OPT_mpure_code = 1931,                     /* -mpure-code */
  OPT_mrestrict_it = 1932,                   /* -mrestrict-it */
  OPT_msched_prolog = 1933,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1934,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1935,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1936, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1937, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 1938,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 1939,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1940,                         /* -mthumb */
  OPT_mthumb_interwork = 1941,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1942,                  /* -mtls-dialect= */
  OPT_mtp_ = 1943,                           /* -mtp= */
  OPT_mtpcs_frame = 1944,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1945,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1946,                         /* -mtune= */
  OPT_muclibc = 1947,                        /* -muclibc */
  ...
  OPT_pie = 1974,                            /* -pie */
  OPT_pipe = 1975,                           /* -pipe */
  OPT_posix = 1976,                          /* -posix */
  OPT_print_file_name_ = 1977,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1978,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1979,          /* -print-multi-directory */
  OPT_print_multi_lib = 1980,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1981,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1982,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1983,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1984,               /* -print-prog-name= */
  OPT_print_search_dirs = 1985,              /* -print-search-dirs */
  OPT_print_sysroot = 1986,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1987,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1988,                    /* -print-value */
  OPT_profile = 1989,                        /* -profile */
  OPT_pthread = 1990,                        /* -pthread */
  OPT_quiet = 1991,                          /* -quiet */
  OPT_r = 1992,                              /* -r */
  OPT_rdynamic = 1993,                       /* -rdynamic */
  OPT_remap = 1994,                          /* -remap */
  OPT_reverse_sort = 1995,                   /* -reverse-sort */
  OPT_s = 1996,                              /* -s */
  OPT_save_temps = 1997,                     /* -save-temps */
  OPT_save_temps_ = 1998,                    /* -save-temps= */
  OPT_shared = 1999,                         /* -shared */
  OPT_shared_libgcc = 2000,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2001,               /* -shared-libphobos */
  OPT_size_sort = 2002,                      /* -size-sort */
  /* OPT_specs = 2003, */                    /* -specs */
  OPT_specs_ = 2004,                         /* -specs= */
  OPT_static = 2005,                         /* -static */
  OPT_static_libasan = 2006,                 /* -static-libasan */
  OPT_static_libgcc = 2007,                  /* -static-libgcc */
  OPT_static_libgfortran = 2008,             /* -static-libgfortran */
  OPT_static_libgm2 = 2009,                  /* -static-libgm2 */
  ...
  OPT_static_libquadmath = 2016,             /* -static-libquadmath */
  ...
  OPT_time = 2081,                           /* -time */
  OPT_time_ = 2082,                          /* -time= */
  OPT_tno_android_cc = 2083,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2084,                 /* -tno-android-ld */
